...
public class ClaimDAO {
	...
	public static int submissionOfInsuranceClaim(Claim c) throws ClassNotFoundException, SQLException {
		...
		ps = con.prepareStatement("INSERT INTO CLAIM_DETAILS VALUES(?,?,?,?,?,?,?,?,?) returning claim_id");
	...
	public static String getPolicyStatusClaimId(int claimId) throws SQLException, ClassNotFoundException {
		...
		ps = con.prepareStatement(
				"SELECT POLICY_TYPE FROM(" + "SELECT INSURANCE.POLICY_TYPE,CLAIM_DETAILS.CLAIM_ID FROM INSURANCE "
						+ "INNER JOIN CLAIM_DETAILS ON INSURANCE.policy_ref_no = CLAIM_DETAILS.policy_ref_no)"
						+ " WHERE CLAIM_ID=?");
		ps.setInt(1, claimId);
