...
public class InsuranceDAO {
	...
	public int registerVehicleInsurancePolicy(VehicleInsurance vehicleInsurance)
		...
		try {
			...
			conn = DBConnection.getConnection();
			pst1 = conn.prepareStatement(
					"INSERT INTO INSURANCE(Customer_Id,Policy_Id,Policy_commencement_Date,Policy_End_Date,Payment_Mode,Payment_Frequency,Policy_Tenure,Policy_Premium_Amount,Policy_Status) VALUES(?,?,?,?,?,?,1,?,'ACTIVE')");
